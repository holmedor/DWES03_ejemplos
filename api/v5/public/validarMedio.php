...
require_once 'includes/header.php';     //cabecera de todas las páginas 
include 'includes/funciones.php';       //funciones definidas 
...
echo "<br>";
?>
<?php require_once "includes/footer.php";     //pie de todas las páginas 
?>